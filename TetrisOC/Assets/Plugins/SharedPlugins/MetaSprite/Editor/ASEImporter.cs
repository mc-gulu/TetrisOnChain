...
public static class ASEImporter {
    ...
    public static void Import(DefaultAsset defaultAsset, ImportSettings settings) {
        ...
        try {
            ...
            GenerateAnimClips(context, context.fileNameNoExt);
    ...
    static void GenerateAnimClips(ImportContext ctx, string baseName) {
        Directory.CreateDirectory(ctx.animClipDirectory);       
        var fileNamePrefix = ctx.animClipDirectory + '/' + baseName; 
